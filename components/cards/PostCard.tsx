      ...
      <div className="flex flex-col flex-grow p-5 pt-4 gap-3">
        ...
        <div className="flex items-center gap-2 pt-4 mt-auto border-t border-[var(--color-stroke)]">
          ...
          <div className="flex items-center gap-2 ml-auto shrink-0">
            ...
            <div className="w-8 h-8 border border-[var(--color-stroke)] flex items-center justify-center text-[var(--color-bone-mute)] group-hover:border-[var(--color-accent)] group-hover:text-[var(--color-accent)] group-hover:bg-[rgba(255, 204, 0,0.08)] transition-all duration-300">
