...
export default function ProjectsPage() {
  return (
    <Container className="relative min-h-screen overflow-x-hidden pt-40 pb-40">
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-grid-pattern-lg opacity-40 [mask-image:radial-gradient(ellipse_at_top,black_10%,transparent_60%)] pointer-events-none"
      />
      ...
      <Section className="!py-0 mb-32 relative">
        ...
        <Reveal delay={0.1}>
          <h1 className="font-display text-[clamp(56px,9vw,140px)] leading-[0.92] text-bone tracking-[-0.04em] mb-10 text-balance">
            Engineered <span className="italic text-bone-dim">artefacts</span>
            <br />
            that stand still.
          </h1>
        </Reveal>
